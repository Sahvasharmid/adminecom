...
import { fetchProducts } from '../../redux/features/ProductSlice/ProductSlice'; // Adjust the import path as necessary
...
export default function StickyHeadTable() {
  const dispatch = useDispatch(); // Dispatch function for actions
  const { products, status } = useSelector((state) => state.products); // Select products and status from the Redux store
